...
const msg = new MsgSend(
  ...
  new Coins([new Coin("uusd", new Int(10).mul(TERRA_DECIMAL))])
);
...
// Fee calculation is a PITA
const taxAmount = await terra.utils.calculateTax(
...
const gasFeeNoTax = new StdFee(
  estimatedFee.gas,
  new Coins({ uusd: gasFeeForGasLimit })
);
